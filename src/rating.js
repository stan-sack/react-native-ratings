...
export default class Rating extends Component {
  static defaultProps = {
    ...
    imageSize: 60,
    onFinishRating: () =>
      console.log("Rating finished. Attach a function here."),
    minValue: 0
  }
  ...
  constructor(props) {
    ...
    const panResponder = PanResponder.create({
      ...
      onPanResponderMove: (event, gesture) => {
        ...
        if (
          gesture.dx <
          ((-this.props.ratingCount + 2 * this.props.minValue) *
  ...
  getCurrentRating(value) {
    ...
    return currentRating.toFixed(fractions)
  }
  ...
  displayCurrentRating() {
    ...
    return (
      <View style={{ ...styles.showRatingView, ...showRatingViewStyle }}>
        <View style={{ ...styles.ratingView, ...ratingViewStyle }}>
          ...
          <Text style={{ ...styles.maxRatingText, ...maxRatingTextStyle }}>
            /{ratingCount}
          </Text>
        </View>
        <View>
...
Rating.propTypes = {
  ...
  showRatingViewStyle: PropTypes.object,
  ratingViewStyle: PropTypes.object,
  ratingTextStyle: PropTypes.object,
  currentRatingTextStyle: PropTypes.object,
  maxRatingTextStyle: PropTypes.object
}
